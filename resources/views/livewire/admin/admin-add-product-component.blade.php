                                ...
                                <form wire:submit.prevent="addProduct">
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <textarea class="form-control" name="short_description"
                                            placeholder="Enter Product Short Description" wire:model="short_description"></textarea>
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <input type="text" name="regular_price" class="form-control"
                                            placeholder="Enter Product Regular_price" wire:model="regular_price">
                                        @error('regular_price')
                                        <p class="text-danger">{{ $message }}</p>
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <select class="form-controle" name="stock_status" >
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <select class="form-controle" name="category_id" wire:model="category_id">
