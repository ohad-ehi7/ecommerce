                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($slides as $slide )
                                        <tr>
                                            <td>{{++$i}}</td>
                                            <td> <img  src="{{ asset('assets/imgs/slider')}}/{{$slide->image}}"  width="120"></td>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('admin.home.slide.edit',['slide_id'=>$slide->id]) }}" class="text-info" style="margin-left: 30px" title="Edit">
                                                    <i class="fi-rs-pencil"></i>
                                                </a>
                                                <a href="#" class=" text-danger" onclick="deleteConfirmation({{$slide->id}})"  style="margin-left: 30px" title="Delete"> <i class="fi-rs-trash"></i></a>
                                            </td>
