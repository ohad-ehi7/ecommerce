                            ...
                            <div class="row align-items-center slider-animated-1">
                                <div class="col-lg-5 col-md-6">
                                    <div class="hero-slider-content-2">
                                        ...
                                        <h1 class="animated fw-900 text-brand">{{ $slide->sunb_title }}</h1>
                                    ...
                                    <div class="product-cart-wrap mb-30">
                                        ...
                                        <div class="product-content-wrap">
                                            ...
                                            <div class="product-action-1 show">
                                                {{-- <a aria-label="Add To Cart" class="action-btn hover-up" href="" wire:click.prevent="store({{$fproduct->id}},{{$fproduct->name}},{{ $fproduct->regula_price}})"><i class="fi-rs-shopping-bag-add"></i></a> --}}
                ...
                <div class="container wow fadeIn animated">
                    ...
                    <div class="carausel-6-columns-cover position-relative">
                        ...
                        <div class="carausel-6-columns" id="carausel-6-columns">
                            @foreach ($pcatogories as $pcategory )
                                
                            
                            <div class="card-1">
                                <figure class=" img-hover-scale overflow-hidden">
                                    <a href="{{route('product.category',['slug'=>$pcategory->slug])}}"> <img src="{{ asset('assets/imgs/shop/categories')}}/{{$pcategories->image}}" alt="{{$category->name}}"></a>
                                </figure>
